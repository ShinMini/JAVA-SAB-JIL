...
public class StartView {
	...
	public static void main(String[] args) {
		...
		TalentDonationProject project1 = service.getDonationProject("01슈바이처");
		TalentDonationProject project2 = service.getDonationProject("09발아비쳐");
		EndView.projectView(project1);
		EndView.projectView(project2);
